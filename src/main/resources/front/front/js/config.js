...
var centerMenu = [
    ...
    ,{
        name: '办事记录',
        url: '../banshijilu/list.html'
    }
    ,{
        name: '办事申请',
        url: '../banshishenqing/list.html'
    }
    ,{
        name: '党员发展',
        url: '../dangyuanfazhanjilu/list.html'
    }
    ,{
        name: '农业补贴',
        url: '../nongyebutie/list.html'
    }
    ,{
        name: '土地变更',
        url: '../tudibiangeng/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '补贴活动通告',
        url: './pages/butiehuodong/list.html'
    },
    {
        name: '公告',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/wangshangjuweihuibanlixitong/admin/dist/index.html#/login";
