  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='文化程度' prop="wenhuaTypes">
                 <el-select v-model="ruleForm.wenhuaTypes"  placeholder='请选择文化程度'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='政治面貌' prop="zhuangtaiTypes">
                 <el-select v-model="ruleForm.zhuangtaiTypes"  placeholder='请选择政治面貌'>
                     <el-option
...
// 注册表 工作人员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.wenhuaTypes)&& 'yonghu'==this.flag){
                             this.$message.error('文化程度不能为空');
                             return
                         }

                         if((!this.ruleForm.zhuangtaiTypes)&& 'yonghu'==this.flag){
