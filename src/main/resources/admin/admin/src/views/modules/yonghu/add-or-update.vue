        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="文化程度" prop="wenhuaTypes">
                        <el-select v-model="ruleForm.wenhuaTypes" :disabled="ro.wenhuaTypes" placeholder="请选择文化程度">
                            <el-option
                                v-for="(item,index) in wenhuaTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="政治面貌" prop="zhuangtaiTypes">
                        <el-select v-model="ruleForm.zhuangtaiTypes" :disabled="ro.zhuangtaiTypes" placeholder="请选择政治面貌">
                            <el-option
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wenhua_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wenhuaTypesOptions = data.data.list;
                    }
                });
                this.$http({
