<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="文化程度编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="文化程度编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="文化程度编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="文化程度编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="文化程度" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="文化程度" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="文化程度" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="wenhua_types";
                        ruleForm["dicName"]="文化程度";
                        this.$http({
