    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">网上村委会业务办理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="文化程度" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.wenhuaTypes" autocomplete="off" placeholder="文化程度"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="政治面貌" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.zhuangtaiTypes" autocomplete="off" placeholder="政治面貌"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            // yonghu 中的 文化程度 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.wenhuaTypes== null ||this.ruleForm.wenhuaTypes== "")){
                            //     this.$message.error("文化程度不能为空");
                            //     return
                            // }
                            // yonghu 中的 政治面貌 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.zhuangtaiTypes== null ||this.ruleForm.zhuangtaiTypes== "")){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/wangshangjuweihuibanlixitong/img/back-img-bg.jpg);
