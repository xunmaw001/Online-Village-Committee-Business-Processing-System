...
//                            yonghuEntity.setWenhuaTypes(Integer.valueOf(data.get(0)));   //文化程度 要改的
//                            yonghuEntity.setZhuangtaiTypes(Integer.valueOf(data.get(0)));   //政治面貌 要改的
