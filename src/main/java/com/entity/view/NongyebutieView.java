...
public class NongyebutieView extends NongyebutieEntity implements Serializable {
	...
	* 农业补贴类型的值
	*/
	@ColumnInfo(comment="农业补贴类型的字典表值",type="varchar(200)")
	private String nongyebutieValue;
	...
	public NongyebutieView() {

	}

	public NongyebutieView(NongyebutieEntity nongyebutieEntity) {
		try {
			BeanUtils.copyProperties(this, nongyebutieEntity);
	...
	* 获取： 农业补贴类型的值
	*/
	public String getNongyebutieValue() {
		return nongyebutieValue;
	}
	/**
	* 设置： 农业补贴类型的值
	*/
	public void setNongyebutieValue(String nongyebutieValue) {
		this.nongyebutieValue = nongyebutieValue;
	}
	...
	public String toString() {
		return "NongyebutieView{" +
			", nongyebutieValue=" + nongyebutieValue +
