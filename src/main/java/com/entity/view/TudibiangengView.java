...
public class TudibiangengView extends TudibiangengEntity implements Serializable {
	...
	* 土地变更类型的值
	*/
	@ColumnInfo(comment="土地变更类型的字典表值",type="varchar(200)")
	private String tudibiangengValue;
	...
	public TudibiangengView() {

	}

	public TudibiangengView(TudibiangengEntity tudibiangengEntity) {
		try {
			BeanUtils.copyProperties(this, tudibiangengEntity);
	...
	* 获取： 土地变更类型的值
	*/
	public String getTudibiangengValue() {
		return tudibiangengValue;
	}
	/**
	* 设置： 土地变更类型的值
	*/
	public void setTudibiangengValue(String tudibiangengValue) {
		this.tudibiangengValue = tudibiangengValue;
	}
	...
	public String toString() {
		return "TudibiangengView{" +
			", tudibiangengValue=" + tudibiangengValue +
